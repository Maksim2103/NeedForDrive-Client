...
import telegram from '../../../../src/assets/images/Telegram_white.svg';
import facebook from '../../../../src/assets/images/Facebook_white.svg';
import instagram from '../../../../src/assets/images/Instagram_white.svg';

const BurgerMenu = () => {
  return (
    <nav className="burger-menu">
      <input type="checkbox" id="checkbox" className="burger-menu__checkbox" />
      <label for="checkbox" class="burger-menu__btn">
